        ...
        for (const d in el.documents) {
          ...
          if (
            ...
            <div class="docs_action">
             ...
             doc.name.trim() ? AddFilterMenuItem(name_menu_item, "name", doc.name) : ""
             doc.status.trim() ? AddFilterMenuItem(status_menu_item, "state", doc.status) : ""
             doc.file_name.trim() ? AddFilterMenuItem(file_menu_item, "file", doc.file_name) : ""
             doc.action.trim() ? AddFilterMenuItem(action_menu_item, "action", doc.action) : ""
